    ...
    <div className={`cart-products-item product_${data._id} row`}>
      ...
      <div className="item-content col-7 col-item">
        ...
        <div className="amount-box">
          ...
          <input className='blur-listener-input' type="number" value={amount} onChange={(e) => setAmount(parseInt(e.target.value))} onBlur={() => onUpdateAmount(amount)} disabled={isLoading} />
